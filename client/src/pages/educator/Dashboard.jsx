...
console.log("educator dashboard token ",token)
      const { data } = await axios.post(backendUrl + '/api/educator/dashboard',{email:user.email},
...
console.log("dashboard data = ", data)
      if (data.success) {
        ...
        console.log("dashboard error 1 ", data)
